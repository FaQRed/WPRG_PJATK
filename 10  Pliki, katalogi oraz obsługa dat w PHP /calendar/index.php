...
<div id="container">
    ...
    <form action="index.php" method="get" id="calendarGenerator">
        <label for="month"></label><input type="text" name="month" placeholder="Miesiąc (mm)" id="month" required>
        <label for="year"></label><input type="text" name="year" placeholder="Rok (yyyy)" id="year" required>
